...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shiny-boat-6f9d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-boat-6f9d
```

A live public deployment of this template is available at [https://shiny-boat-6f9d.templates.workers.dev](https://shiny-boat-6f9d.templates.workers.dev)
